  ...
  return (
    ...
    >
      <div className="relative group">
        <div className="relative space-y-2 xs:space-y-3 sm:space-y-4 md:space-y-5 bg-[#284f29] p-3 xs:p-4 sm:p-5 md:p-6 lg:p-7 rounded-lg xs:rounded-xl sm:rounded-2xl border border-white/10 shadow-md">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 xs:gap-1.5 sm:gap-2 mt-2 xs:mt-3 sm:mt-4 md:mt-5 px-3 xs:px-4 sm:px-5 md:px-6 py-1.5 xs:py-2 sm:py-2.5 md:py-3 bg-[#C7962D] text-white text-xs xs:text-xs sm:text-sm md:text-base rounded-md xs:rounded-lg hover:bg-[#C7962D]/80 transition-all duration-300"
          >
            Get Directions
      ...
      >
        <div className="relative h-full space-y-2 xs:space-y-3 sm:space-y-4 md:space-y-5 bg-[#284f29] p-3 xs:p-4 sm:p-5 md:p-6 lg:p-7 rounded-lg xs:rounded-xl sm:rounded-2xl border border-white/10 shadow-md">
          ...
          <div className="flex flex-wrap gap-1 xs:gap-1.5 sm:gap-2 md:gap-3 pt-1 xs:pt-1.5 sm:pt-2">
            {[
              ...
              <span
                key={index}
                className="px-1.5 xs:px-2 sm:px-3 md:px-4 py-0.5 xs:py-1 sm:py-1.5 md:py-2 bg-[#1B4D2E]/40 text-[#C7962D] rounded-full text-xs xs:text-xs sm:text-xs md:text-sm font-medium border border-[#C7962D]/30"
              >
                {feature}
              </span>
            ))}
