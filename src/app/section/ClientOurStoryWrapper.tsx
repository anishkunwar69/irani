...
// Dynamic import of motion components with no SSR to reduce initial bundle size
...
// Background effects component to be deferred
function BackgroundEffects() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-0 animate-fadeIn" style={{ animationDelay: '100ms', animationFillMode: 'forwards' }}>
...
function ClientOurStoryWrapper({ children }: ClientOurStoryWrapperProps) {
  ...
  // Defer background effects after component mount
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* Simple gradient background that loads instantly */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0C1F0E] via-[#1B4D2E] to-[#2E372E]"></div>
