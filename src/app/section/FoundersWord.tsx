...
import FoundersWordsContent from "../components/founders-words/FoundersWordsContent";
  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        ...
        <div className="absolute top-[5vh] xs:top-[10vh] sm:top-[15vh] md:top-[20vh] lg:top-40 left-[5%] sm:left-[8%] lg:left-[10%] xl:left-20 w-[60vw] h-[60vw] xs:w-[50vw] xs:h-[50vw] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px]">
        ...
        <div className="absolute -bottom-[10vh] xs:-bottom-[5vh] right-[5%] sm:right-[8%] lg:right-[10%] xl:right-20 w-[50vw] h-[50vw] xs:w-[45vw] xs:h-[45vw] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px]">
